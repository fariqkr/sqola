...
<div class="w-full flex">
    ...
    <div class="w-7/12 flex flex-col items-center py-12 px-8 bg-gray-200" style="margin-left: 16.67%; margin-right: 25%">
        ...
        <div class="px-5 flex justify-evenly w-full mb-10">
            ...
            <a href="/categories/11/kimia" class="font-semibold text-gray-500">Kimia</a>
            ...
            <a href="/categories/11/inggris" class="font-semibold underline">B. Inggris</a>
        </div>
        ...
        <div class="flex flex-col w-full">
            <a href="#" class="w-full bg-purple-200 border-2 border-gray-300 px-8 py-3 inline-grid grid-cols-3 justify-center items-center rounded-2xl mb-6">
                ...
                <span class="col-span-2 text-gray-600 font-semibold italic text-2xl text-center">Past Perfect Tense</span>
            </a>

            <a href="#" class="w-full bg-purple-200 border-2 border-gray-300 px-8 py-3 inline-grid grid-cols-3 justify-center items-center rounded-2xl mb-6">
                <span class="col-span-1 text-purple-500 font-bold text-3xl border-r-2 text-center border-gray-300">Inggris</span>
                <span class="col-span-2 text-gray-600 font-semibold italic text-2xl text-center">Simple Future Tense</span>
            </a>

            <a href="#" class="w-full bg-purple-200 border-2 border-gray-300 px-8 py-3 inline-grid grid-cols-3 justify-center items-center rounded-2xl mb-6">
                <span class="col-span-1 text-purple-500 font-bold text-3xl border-r-2 text-center border-gray-300">Inggris</span>
                <span class="col-span-2 text-gray-600 font-semibold italic text-2xl text-center">Present Continuous Tense</span>
            </a>

            <a href="#" class="w-full bg-purple-200 border-2 border-gray-300 px-8 py-3 inline-grid grid-cols-3 justify-center items-center rounded-2xl mb-6">
                <span class="col-span-1 text-purple-500 font-bold text-3xl border-r-2 text-center border-gray-300">Inggris</span>
                <span class="col-span-2 text-gray-600 font-semibold italic text-2xl text-center">Pronoun</span>
            </a>

            <a href="#" class="w-full bg-purple-200 border-2 border-gray-300 px-8 py-3 inline-grid grid-cols-3 justify-center items-center rounded-2xl mb-6">
                <span class="col-span-1 text-purple-500 font-bold text-3xl border-r-2 text-center border-gray-300">Inggris</span>
                <span class="col-span-2 text-gray-600 font-semibold italic text-2xl text-center">Narrative Text</span>
            </a>
        </div>
    </div>
