...
<div class="w-full flex">
    ...
    <div class="w-7/12 flex flex-col items-center py-12 px-8 bg-gray-200" style="margin-left: 16.67%; margin-right: 25%">
        ...
        <div class="px-5 flex justify-evenly w-full mb-10">
            ...
            <a href="/categories/11/matematika" class="font-semibold underline">Matematika</a>
        ...
        <div class="flex flex-col w-full">
            ...
            <a href="#" class="w-full bg-red-100 border-2 border-gray-300 px-8 py-3 inline-grid grid-cols-3 justify-center items-center rounded-2xl mb-6">
                <span class="col-span-1 text-red-500 font-bold text-3xl border-r-2 text-center border-gray-300">Matematika</span>
                <span class="col-span-2 text-gray-600 font-semibold italic text-2xl text-center">Logaritma</span>
            </a>

            <a href="#" class="w-full bg-red-100 border-2 border-gray-300 px-8 py-3 inline-grid grid-cols-3 justify-center items-center rounded-2xl mb-6">
                <span class="col-span-1 text-red-500 font-bold text-3xl border-r-2 text-center border-gray-300">Matematika</span>
                <span class="col-span-2 text-gray-600 font-semibold italic text-2xl text-center">Eksponen</span>
            </a>

            <a href="#" class="w-full bg-red-100 border-2 border-gray-300 px-8 py-3 inline-grid grid-cols-3 justify-center items-center rounded-2xl mb-6">
                <span class="col-span-1 text-red-500 font-bold text-3xl border-r-2 text-center border-gray-300">Matematika</span>
                <span class="col-span-2 text-gray-600 font-semibold italic text-2xl text-center">Persamaan Linear Mutlak</span>
            </a>

            <a href="#" class="w-full bg-red-100 border-2 border-gray-300 px-8 py-3 inline-grid grid-cols-3 justify-center items-center rounded-2xl mb-6">
                <span class="col-span-1 text-red-500 font-bold text-3xl border-r-2 text-center border-gray-300">Matematika</span>
                <span class="col-span-2 text-gray-600 font-semibold italic text-2xl text-center">Fungsi Kuadrat</span>
            </a>

            <a href="#" class="w-full bg-red-100 border-2 border-gray-300 px-8 py-3 inline-grid grid-cols-3 justify-center items-center rounded-2xl mb-6">
                <span class="col-span-1 text-red-500 font-bold text-3xl border-r-2 text-center border-gray-300">Matematika</span>
                <span class="col-span-2 text-gray-600 font-semibold italic text-2xl text-center">Pertidaksamaan</span>
            </a>
        </div>
    </div>
