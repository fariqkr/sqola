...
<div class="w-full flex">
    ...
    <div class="w-7/12 flex flex-col items-center py-12 px-8 bg-gray-200" style="margin-left: 16.67%; margin-right: 25%">
        ...
        <div class="px-5 flex justify-evenly w-1/2 mb-4">
            ...
            <a href="#" class="font-semibold underline">Kelas 11</a>
            <a href="/categories/12/fisika" class="font-semibold text-gray-500">Kelas 12</a>
        </div>

        <div class="px-5 flex justify-evenly w-full mb-10">
            <a href="/categories/11/fisika" class="font-semibold text-gray-500">Fisika</a>
            <a href="/categories/11/matematika" class="font-semibold text-gray-500">Matematika</a>
            <a href="/categories/11/kimia" class="font-semibold underline">Kimia</a>
            <a href="/categories/11/biologi" class="font-semibold text-gray-500">Biologi</a>
            <a href="/categories/11/indonesia" class="font-semibold text-gray-500">B. Indonesia</a>
            <a href="/categories/11/inggris" class="font-semibold text-gray-500">B. Inggris</a>
        </div>
        ...
        <div class="flex flex-col w-full">
            <a href="#" class="w-full bg-blue-100 border-2 border-gray-300 px-8 py-3 inline-grid grid-cols-3 justify-center items-center rounded-2xl mb-6">
                <span class="col-span-1 text-blue-500 font-bold text-3xl border-r-2 text-center border-gray-300">Kimia</span>
                <span class="col-span-2 text-gray-600 font-semibold italic text-2xl text-center">Reaksi Redoks</span>
            </a>

            <a href="#" class="w-full bg-blue-100 border-2 border-gray-300 px-8 py-3 inline-grid grid-cols-3 justify-center items-center rounded-2xl mb-6">
                <span class="col-span-1 text-blue-500 font-bold text-3xl border-r-2 text-center border-gray-300">Kimia</span>
                <span class="col-span-2 text-gray-600 font-semibold italic text-2xl text-center">Bilangan Oksidasi</span>
            </a>

            <a href="#" class="w-full bg-blue-100 border-2 border-gray-300 px-8 py-3 inline-grid grid-cols-3 justify-center items-center rounded-2xl mb-6">
                <span class="col-span-1 text-blue-500 font-bold text-3xl border-r-2 text-center border-gray-300">Kimia</span>
                <span class="col-span-2 text-gray-600 font-semibold italic text-2xl text-center">Hukum Kekekalan Massa</span>
            </a>

            <a href="#" class="w-full bg-blue-100 border-2 border-gray-300 px-8 py-3 inline-grid grid-cols-3 justify-center items-center rounded-2xl mb-6">
                <span class="col-span-1 text-blue-500 font-bold text-3xl border-r-2 text-center border-gray-300">Kimia</span>
                <span class="col-span-2 text-gray-600 font-semibold italic text-2xl text-center">Atom</span>
            </a>

            <a href="#" class="w-full bg-blue-100 border-2 border-gray-300 px-8 py-3 inline-grid grid-cols-3 justify-center items-center rounded-2xl mb-6">
                <span class="col-span-1 text-blue-500 font-bold text-3xl border-r-2 text-center border-gray-300">Kimia</span>
                <span class="col-span-2 text-gray-600 font-semibold italic text-2xl text-center">Tabel Periodik</span>
            </a>

            <a href="#" class="w-full bg-blue-100 border-2 border-gray-300 px-8 py-3 inline-grid grid-cols-3 justify-center items-center rounded-2xl mb-6">
                <span class="col-span-1 text-blue-500 font-bold text-3xl border-r-2 text-center border-gray-300">Kimia</span>
                <span class="col-span-2 text-gray-600 font-semibold italic text-2xl text-center">Ikatan Ion</span>
            </a>

            <a href="#" class="w-full bg-blue-100 border-2 border-gray-300 px-8 py-3 inline-grid grid-cols-3 justify-center items-center rounded-2xl mb-6">
                <span class="col-span-1 text-blue-500 font-bold text-3xl border-r-2 text-center border-gray-300">Kimia</span>
                <span class="col-span-2 text-gray-600 font-semibold italic text-2xl text-center">Larutan Elektrolit</span>
            </a>
        </div>
    </div>
