...
@section('content')
<h1 class="text-4xl font-semibold mb-10">Quiz 1</h1>

<!-- Questions -->
<form action="{{ route('course.quiz', $course->id) }}" method="POST" class="px-10 pb-8 bg-gray-200 w-full">
    @csrf
    <div class="pt-8">
...
<div class="w-full flex justify-between mt-12">
    <a href="{{ route('course.course', $course->id) }}" class="bg-blue-500 py-2 text-white rounded-lg text-center font-semibold w-1/6 hover:bg-blue-600">Previous</a>
    <button class="bg-blue-500 py-2 text-white rounded-lg text-center font-semibold w-1/6 hover:bg-blue-600" style="display: none">Next</button>
</div>
