...
<div class="px-24 py-12">
    <div class="w-full py-24 bg-yellow-200">
        <h1 class="font-bold text-6xl text-center">Nama Materi</h1>
    </div>

    <div class="grid grid-cols-4 mt-8 bg-yellow-100">
        <div class="col-span-1 px-8 py-10 border-r-2 border-gray-300">
            <p class="bg-blue-500 py-2 px-8 text-white rounded-lg mb-4 text-center font-semibold mx-3">Nama Materi</p>
            ...
            <div class="grid grid-cols-4 gap-x-2 gap-y-1 auto-rows-fr">
                ...
                <!-- Submateri -->
                <p class="col-span-3 py-2 px-1 bg-gray-200 font-semibold text-sm">Sub Materi 2</p>
